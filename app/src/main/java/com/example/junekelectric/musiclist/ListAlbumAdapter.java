...
public class ListAlbumAdapter extends ArrayAdapter<Album>{
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        //TODO albumArtの画像の大きさを比率で

        holder.artworkImageView.setImageResource(R.drawable.dummy);
        if(path==null){
            path = String.valueOf(R.drawable.dummy);
            Bitmap bitmap = ImageCache.getImage(path);
            if(bitmap==null){
                bitmap = BitmapFactory.decodeResource(Mcontext.getResources(),R.drawable.dummy);
